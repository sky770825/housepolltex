...
echo.
echo 您的網站已成功更新：
echo GitHub: https://github.com/sky770825/housepolltex
...
echo  下架資訊：
echo   時間：%date% %time%
echo   GitHub：https://github.com/sky770825/housepolltex (現在是空白)
echo   網站：https://sky770825.github.io/housepolltex/ (無法顯示)
echo.
